...
void loop() {
  ...
  if (ppm >= 20 && ppm < 100) {
    Serial.println("Carbon Monoxide Gas detected");
  }
  else if (ppm >= 100 && ppm < 200) {
    Serial.println("Carbon Monoxide; Alcohol; Hydrogen Gases Detected");
  }
  else if (ppm >= 200 && ppm < 300) {
    Serial.println("Carbon Monoxide; Alcohol; Hydrogen; LPG Gases Detected");
  } 
  else if (ppm >= 300) {
    Serial.println("Carbon Monoxide; Alcohol; Hydrogen; LPG; Methane; Smoke Gases Detected");
  }
