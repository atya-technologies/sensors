...
void setup() {
  ...
  Serial.println("Calibrating MQ-3 in clean air...");
...
void loop() {
  ...
  if (ppm >= 50 && ppm < 100) {
    Serial.println("Ehanol(Alcohol)");
  }
  else if (ppm >= 100 && ppm < 800) {
    Serial.println("Ethanol(Alcohol); Benzine; Hexane");
  }
  else if (ppm >= 800 && ppm < 1000) {
    Serial.println("Ethanol(Alcohol); Benzine; Hexane; Butane");
  } 
  else if (ppm >= 1000) {
    Serial.println("Ethanol(Alcohol); Benzine; Hexane; Butane/Propane");
  }
