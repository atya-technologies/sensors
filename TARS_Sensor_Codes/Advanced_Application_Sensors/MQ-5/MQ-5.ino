...
void setup() {
  ...
  Serial.println("Calibrating MQ-5 in clean air...");
...
void loop() {
  ...
  if (ppm >= 100 && ppm < 200) {
    ...
    Serial.println("Butane/Propane; Methane (CH₄); Hydrogen (H₂)");
  } 
  else if (ppm >= 5000) {
    Serial.println("Butane/Propane; Methane (CH₄); Hydrogen (H₂); Town Gas (CO + CH₄ + H₂)");
  }
