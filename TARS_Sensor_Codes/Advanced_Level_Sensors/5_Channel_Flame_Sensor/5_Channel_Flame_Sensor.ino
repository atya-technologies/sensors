...
void loop() {
  ...
  if (digitalRead(flameSensorPin1) == LOW) { // Flame detected if sensor pin reads LOW
    Serial.println("Fire detected in 1");
  } else {
    Serial.println("No Fire detected in 1");
  }
  Serial.println();
  Serial.print("5 Channel Flame Sensor:");
  if (digitalRead(flameSensorPin2) == LOW) { // Flame detected if sensor pin reads LOW
    Serial.println("Fire detected in 2");
  } else {
    Serial.println("No Fire detected in 2");
  }
  Serial.println();
  Serial.print("5 Channel Flame Sensor:");
  if (digitalRead(flameSensorPin3) == LOW) { // Flame detected if sensor pin reads LOW
    Serial.println("Fire detected in 3");
  } else {
    Serial.println("No Fire detected in 3");
  }
  Serial.println();
  Serial.print("5 Channel Flame Sensor:");
  if (digitalRead(flameSensorPin4) == LOW) { // Flame detected if sensor pin reads LOW
    Serial.println("Fire detected in 4");
  } else {
    Serial.println("No Fire detected in 4");
  }
  Serial.println();
  Serial.print("5 Channel Flame Sensor:");
  if (digitalRead(flameSensorPin5) == LOW) { // Flame detected if sensor pin reads LOW
    Serial.println("Fire detected in 5");
  } else {
    Serial.println("No Fire detected in 5");
  }
  Serial.println();
  delay(1000);
}
